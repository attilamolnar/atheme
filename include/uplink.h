...
E uplink_t *uplink_add(const char *name, const char *host, const char *send_password, const char *receive_password, const char *vhost, int port, bool uses_ssl, const char *ssl_fingerprint);
